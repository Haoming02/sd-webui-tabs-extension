...
def add_ui_settings():
    ...
    shared.opts.add_option(
        "tabs_ex_act_color",
        shared.OptionInfo("greenyellow", "Color for active Extensions", section=section)
        .link("CSS", "https://www.w3schools.com/cssref/css_colors.php")
        .needs_reload_ui(),
    )
    shared.opts.add_option(
        "tabs_ex_forge",
        shared.OptionInfo(False, 'Hide the "Integrated" text', section=section)
...
def load_ui_settings():
    color = getattr(shared.opts, "tabs_ex_act_color", "greenyellow")
    ln = 1
